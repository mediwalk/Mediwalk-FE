...
const MonthlyRewardHistory = () => {
  ...
  return (
    <div className="h-dvh flex flex-col px-5">
      ...
      <main className="flex flex-col flex-1 min-h-0 gap-5 pt-6 pb-15">
        ...
        <section className="flex flex-col flex-1 gap-2 min-h-0">
          <div className="flex relative justify-between items-center shrink-0">
          ...
          <div className="flex flex-col flex-1 gap-2 overflow-hidden overflow-y-auto no-scrollbar">
